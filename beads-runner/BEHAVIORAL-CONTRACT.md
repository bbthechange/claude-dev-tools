...
**Source:** 1021–1034 (generic template + closing dep-add instruction); the overflow-specific reason is composed at the CONTEXT_OVERFLOW dispatch arm (2482–2493 region).
...
**Source:** 1197–1237 (definition; patterns self-flagged brittle at ~1215), invoked at 2536 (outside the dispatch `case`).
...
**Source:** 1391–1400 (`notify_user`); noisy call sites 2429/2447/2476/2488/2523/1626 + 1227 (subagent) + 1386 (discipline); silent: 2466 (rate-limit), 2507 (first task-not-closed), SUCCESS (none).
...
**Source:** 2015–2042 (`rate_limit_event` case; `RATE_LIMIT_QUOTA=` at 2036).
