...
# ztb6 source-mode guard: BEADS_RUNNER_TEST_MODE=1 lets a test (or a startup-
...
while true; do
  ...
  # ztb6 / epic vvgy: emit a workspace_inventory snapshot at pickup so the
...
$PROMPT"
  ...
  # ztb6 / epic vvgy: emit a workspace_inventory snapshot at completion so the
